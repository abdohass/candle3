...
class CustomTextStyle {
  ...
  static TextStyle get titleWhiteTextStyle => const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold);
  ...
  static TextStyle get bodyWhiteTextStyle => const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.normal);
}
